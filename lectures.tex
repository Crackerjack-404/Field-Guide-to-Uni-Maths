...
Each year, you will study four modules each semester (excluding Core Skills), so eight across both semesters. Each module has three lectures per week lasting about 45 minutes, along with problem classes. 

Lecturers will normally provide lecture notes or slides beforehand, which can be found on Blackboard. It’s worth having a quick look at these before the lecture if you can, even just seeing the headings can make it much easier to follow what’s happening when you’re sitting in the lecture hall.

The important thing to remember is that lectures are only one part of the learning process. They introduce the ideas, but most of the real understanding comes later when you spend time thinking about the material yourself, working through problems, and discussing things with other students.
...
% info on core skills module? - what it's about..? 
...
\subsection{A note on talking in lectures}
% Basically - pls shut the fuck up and dont' talk over lectueres, it's rude, distruptive, interrupts other people's focus 

Lectures are shared learning spaces and everyone in the room is trying to concentrate on the same material. 

It might seem harmless to chat quietly during a lecture, but even small conversations can be a distracting for the people sitting nearby especially with an attention demanding subject like maths. 
