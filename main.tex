...
\input{tex/01-the jump}

\mychapter{2}{Lectures and Coursework}
\input{tex/02-lectures and coursework}

\mychapter{3}{Workshops and Other Resources}
\input{tex/03-workshops and other resources}
% intro needs writing up - ask Jacob as well 
% office hrs/other info section needs finishing

\mychapter{4}{Problem Solving}
\input{tex/04-problem Solving}

\mychapter{5}{Exams}
\input{tex/05-exams}

\mychapter{6}{Time Management}
\input{tex/06-time Management}

\mychapter{7}{Future}
\input{tex/07-future}

\mychapter{8}{Useful Links}
\input{tex/08-useful Links}
