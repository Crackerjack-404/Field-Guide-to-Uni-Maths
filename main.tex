...
{\textit{Professor Graham A. Niblo}}
...
\begin{tcolorbox}[colback=blue!5!white, colframe=blue!75!black, title=Disclaimer]
This guide reflects one student's experience of first-year mathematics at Southampton, not official university policy. For regulatory issues, always consult university's own guidance through the Student Hub rather than relying on this guide.
\end{tcolorbox}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{xkcd/manuels.png}
    \caption{\textbf{\href{https://xkcd.com/1343/}{Manuals}}}
\end{figure}
...
% Need to cut down on word count for courseowrk section + add relevant links 
...
\input{tex/07-Common Terms, Abbreviations, and Useful Links}
