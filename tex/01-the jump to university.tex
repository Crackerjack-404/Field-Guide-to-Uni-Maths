...
\subsection{For When Your Brain Just Isn't Working}
...
And if your brain truly isn't cooperating despite your best efforts, just accept that for what it is. Stay present as best you can, then review the material later when you're more alert.

One unfocused lecture does not define your trajectory\footnote{Pun intended}. Boredom, distraction, fatigue are all part of the learning experience, and learning to work with them rather than against them is part of becoming a good learner.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{xkcd/tenThousand.png}
    \caption{\textbf{\href{https://xkcd.com/1053/}{Ten Thousand}}}
\end{figure}
