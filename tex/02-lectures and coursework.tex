...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{xkcd/setTheory.png}
    \caption{\textbf{\href{https://xkcd.com/982/}{Set Theory}}}
\end{figure}


\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{xkcd/complexNumbers.png}
    \caption{\textbf{\href{https://xkcd.com/2028/}{Complex Numbers}}}
\end{figure}
